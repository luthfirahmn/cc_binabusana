                    ...
                    <form id="formAction">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    $array_url = array(
                                        ...
                                        "value" => isset($all_data->asset_name) ? $all_data->asset_name : ''
                                    );
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="asset_type_code" class="form-control">
                                        <option
                                            value=<?= isset($all_data->asset_type_code) ? $all_data->asset_type_code : '' ?>>
                                            <?= isset($all_data->asset_type_code) ? $all_data->type : 'Choose Room Type' ?>
                                            <?php
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="area_code" class="form-control">
                                        <option value=<?= isset($all_data->area_code) ? $all_data->area_code : '' ?>>
                                            <?= isset($all_data->area_code) ? $all_data->area_name : 'Choose Area' ?>
                                            <?php
                                            foreach ($area as $row) {
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    $array_url = array(
                                        ...
                                        "id" => "price",
                                        "placeholder" => "Price",
                                        "value" => isset($all_data->price) ? $all_data->price : ''
                                    );
                                    echo form_input($array_url); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="status_id" class="form-control">
                                        <option value=<?= isset($all_data->status_id) ? $all_data->status_id : '' ?>>
                                            <?= isset($all_data->status_id) ? $all_data->status : 'Choose Status' ?>
                                            <?php
                            ...
                            <input type="hidden" name="id" value="<?= isset($all_data->id) ? $all_data->id : ''; ?>" />
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.error == false) {
                ...
                window.location.href = '<?= site_url('asset') ?>'
            } else {
